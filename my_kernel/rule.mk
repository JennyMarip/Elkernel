...
all:
	...
	@${CC} ${CFLAGS} -c ${FILE_SYS}      -o ./bin/${FS}.o
	@${CC} ${CFLAGS} -c ${TRAP_VEC}      -o ./bin/${TRAP}.o
	@${CC} ${CFLAGS} ./bin/${EXEC}.o ./bin/${TRAP}.o ./bin/${UART}.o -Ttext=0x80200000 -o ./bin/${EXEC}.elf
	@${CC} ${CFLAGS} ./bin/${BOOT}.o ./bin/${FS}.o   ./bin/${UART}.o -Ttext=0x80000000 -o ./bin/${BOOT}.elf
